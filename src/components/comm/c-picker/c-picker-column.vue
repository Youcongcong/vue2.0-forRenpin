...
<template>
  <div :class="['c-picker-column', class]" @touchstart.prevent="_dragstart($event)" @touchmove.prevent="_drag($event)" @touchend.prevent="_dragend($event)">
    <div class="c-picker-column-scroller"></div>
    <div class="c-picker-column-content" :style="{transform: transform}">
