<template>
  <div :class="['c-datepicker', class]" v-focus="show" v-show="show" tabindex="-1" transition="fade">
    <c-mask class="c-datepicker-mask" @touchend.prevent="show = false"></c-mask>
    <div class="c-datepicker-body" @touchmove.prevent>
      ...
      <div class="c-datepicker-content">
        <template v-for="(index, column) in columns" track-by="index">
          <c-picker-column v-if="column.type === 'picker'" :class="column.class" :size="size" :value="column.value" :items="column.items"
...
import { CPickerColumn } from '../c-picker'
export default {
  name: 'c-datepicker',
  props: {
    class: {
